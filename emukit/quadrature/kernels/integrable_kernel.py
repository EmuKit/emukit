...
class IIntegrableKernelIsDifferentiable():
...
class IntegrableDifferentiableKernel(IntegrableKernel, IIntegrableKernelIsDifferentiable):
    """
    An integrable kernel that is also differentiable
    """
    def __init__(self, input_dim: int, integral_bounds: IntegralBounds) -> None:
        super(IntegrableDifferentiableKernel, self).__init__(input_dim, integral_bounds)
