...
def test_negative_lower_confidence_bound_acquisition_shape(acquisition):
...
def test_negative_lower_confidence_bound_acquisition_gradient_computation(acquisition):
    rng = np.random.RandomState(43)
    x_test = rng.rand(10, 2)
